...
- `IMAGE_EVIDENCE_MIN_OCR_SIMILARITY` (default `0.60`; minimum name fuzzy score for image verification)
- `IMAGE_EVIDENCE_MIN_FAISS_SCORE` (default `0.55`; minimum FAISS score for image verification)
- `IMAGE_EVIDENCE_MIN_MANA_CONFIDENCE` (default `0.30`; minimum pip-detection confidence for mana color evidence)

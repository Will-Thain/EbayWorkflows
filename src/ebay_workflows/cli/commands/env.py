...
def validate_env() -> None:
    ...
    table.add_row("PHASE1_FETCH_ITEM_DESCRIPTION", str(settings.phase1_fetch_item_description))
    table.add_row("MATCH_EVENT_LOG_ENABLED", str(settings.match_event_log_enabled))
    table.add_row("MATCH_EVENT_LOG_PATH", settings.match_event_log_path)

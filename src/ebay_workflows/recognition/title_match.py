"""Phase 2 listing-title fuzzy match (workflow concern, not image cascade)."""
...
def rank_title_matches(
    ...
    *,
    ...
    max_candidates = max(prefilter_size, top_k * 20)
    candidate_indices = index.candidate_indices(title, max_candidates=max_candidates)
